package principle.segeregation.improve;

/**
 * 使用接口隔离原则
 * @author Acyco
 * @create 2020-01-08 01:36
 */
...
class A { //A类通过接口Interface1,Interface2 依赖（使用）B类， 但只会用到1,2,3方法
...
class C {//C类通过接口Interface1,Interface3 依赖（使用）D类， 但只会用到1,4,5方法
